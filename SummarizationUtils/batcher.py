...
import SummarizationUtils.data as data
...
class Batch(object):
    ...
    def init_encoder_seq(self, example_list, hps):
        ...
        if hps.pointer_gen:
            ...
            single_max_art_oovs = max([len(ex.article_oovs) for ex in example_list])
            self.max_art_oovs = [single_max_art_oovs] * hps.batch_size
